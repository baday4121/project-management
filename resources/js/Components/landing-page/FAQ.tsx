...
const FAQList: FAQProps[] = [
  {
    question: "Is Workdei free to use?",
    answer:
      "Yes! Workdei is completely free to use with all features included. No credit card required, no hidden fees, and no usage limits.",
    value: "pricing",
  },
  {
    question: "How do project roles work in Workdei?",
    answer:
  ...
  {
    question: "How do I organize tasks in Workdei?",
    answer:
      "Workdei offers multiple ways to organize tasks: custom labels for categorization, priority settings, due dates, and assignees. You can filter and search tasks using any of these parameters to quickly find what you need.",
    value: "organization",
  },
  {
    question: "Can I use Workdei for multiple projects?",
    answer:
