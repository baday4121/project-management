...
const testimonials: TestimonialProps[] = [
  {
    ...
    comment:
      "Workdei has revolutionized how we handle project workflows. The task management and labeling system is incredibly intuitive.",
  },
  {
  ...
  },
  {
    ...
    comment:
      "Workdei has significantly improved our team's productivity. The ability to track tasks and collaborate in real-time is invaluable.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p className="pb-8 pt-4 text-xl text-muted-foreground">
        See how Workdei helps teams collaborate better and deliver projects faster
      </p>
